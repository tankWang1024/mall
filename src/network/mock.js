...
Mock.mock("mock/home/data?type=pop&page=1", {
  data: {
    list: [{
      id: 'pop1',
      price: 100.00,
...
Mock.mock("mock/home/data?type=pop&page=2", {
  data: {
    list: [{
        id: 'pop11',
        price: 120.99,
...
Mock.mock("mock/home/data?type=new&page=1", {
  data: {
    list: [{
      id: 'new1',
      price: 46,
      cfav: 10,
      imgUrl: 'https://s11.mogucdn.com/mlcdn/776a41/200316_7ifd932aiii6f0895hb1gjg4jej2d_750x1000.jpg_468x468.jpg',
      title: '夏季新款韩版短袖T恤女圆领双层亮丝拼粉色学生体恤上衣'
    }, {
      id: 'new2',
      price: 46,
      cfav: 10,
...
Mock.mock("mock/home/data?type=new&page=2", {
  data: {
    list: [{
      id: 'new11',
      price: 45.98,
      cfav: 40,
      imgUrl: 'https://s5.mogucdn.com/mlcdn/c45406/200316_2f29djhe1k5bi05gd52lhb041054b_2000x3000.jpg_468x468.jpg',
      title: '新款女装大码格子衬衫女长袖衬衣外套中长款chic上衣 秋季'
    }, {
      id: 'new12',
      price: 45.98,
      cfav: 40,
...
Mock.mock("mock/home/data?type=sell&page=1", {
  data: {
    list: [{
        id: 'sell1',
        price: 169.00,
        cfav: 90,
        imgUrl: 'https://s5.mogucdn.com/mlcdn/c45406/190824_66j01k6hj7ic99jjei42d2fa1d669_640x960.jpg_468x468.jpg',
        title: '宿本2019年秋季新款心机流行裙子洋气减龄小清新雪纺连衣裙'
      },
      {
        id: 'sell2',
        price: 169.00,
...
Mock.mock("mock/detail?id=pop1", {
  banner: [{
    ...
    {
      img: 'https://s5.mogucdn.com/mlcdn/c45406/200105_0l0fgh32l867k4ddc5il104691kij_4222x6333.jpg_468x468.jpg'
    }
  ],
  info: {
    ...
    favNum: 73,
    promise: '72小时发货',
    promises: ['退货补运费', '全国包邮', '7天无理由退货'],
    sellerLogo: 'https://s11.mogucdn.com/mlcdn/c45406/171025_0ahe5dkfe16a62bj9h4dedc2kb4gi_200x200.jpg_100x100.jpg',
    sellerName: 'NVNA女娜家',
    sellAccount: '5.9万',
    goodsAccount: 320,
    describe: [{
  ...
  goodsDesc: {
    ...
    describe: [
      ['裙型', '开衩', '袖型', '衣门襟', '材质', '摆型', '腰型', '版型', '季节', '领型'],
      ['A字裙', '无开衩', '衬衫袖', '拉链', '其他', '常规', '高腰', '收腰', '春季', '立领']
    ]
  },
  comments: {
    uimg: 'https://img.alicdn.com/tps/i3/TB1yeWeIFXXXXX5XFXXuAZJYXXX-210-210.png',
    uname: '我只有三块钱',
    createdTime: 1584759404606,
    style: '颜色：白色斑点 尺码：L',
